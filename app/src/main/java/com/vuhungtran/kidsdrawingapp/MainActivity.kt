package com.vuhungtran.kidsdrawingapp
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var imButtonUndo: ImageButton = findViewById(R.id.ib_undo)
        imButtonUndo.setOnClickListener{
            drawingView?.onClickUndo()
        }

        var imageSave: ImageButton = findViewById(R.id.ib_save)
    ...
    //Check permission
    private val cameraAndLocationResultLauncher: ActivityResultLauncher<Array<String>> = registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()){
        permissions ->
    ...
    /**
     * We are calling this method to check permission  status
     */
